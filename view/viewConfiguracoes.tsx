  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6 items-start">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-3 sm:p-4 flex flex-col gap-1 shadow-sm w-full">
          {[
            ...
            <button
              ...
              className={`flex items-center gap-3 px-3 sm:px-4 py-3 sm:py-3.5 rounded-xl text-xs font-semibold transition text-left ${
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] text-gray-400 font-normal mt-0.5 truncate">{sub}</p>
              </div>
            </button>
          ))}
        </div>
        ...
        <div className="lg:col-span-3 bg-white border border-gray-100 rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm w-full min-w-0">
          ...
          {abaAtiva === "perfil" && (
            <form onSubmit={handleSalvarAlteracoes} className="space-y-6">
              <div className="flex items-center gap-4 sm:gap-5 pb-4 border-b border-gray-50 flex-wrap">
                <div onClick={acionarInputArquivo} className="relative group w-16 h-16 sm:w-20 sm:h-20 cursor-pointer shrink-0">
                  {avatarUrl ? (
                    <img src={avatarUrl} alt="Avatar" className="w-full h-full rounded-full object-cover border border-gray-200 shadow-sm" />
                  ) : (
                    <div className="w-full h-full rounded-full bg-blue-600 text-white flex items-center justify-center text-xl sm:text-2xl font-bold">
                ...
                <div className="min-w-0">
                  <h3 className="text-base sm:text-lg font-bold text-gray-800 truncate">{nome || "Carregando..."}</h3>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-4 border-t border-gray-50">
                ...
                <button type="submit" disabled={carregando} className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm px-6 py-2.5 rounded-xl transition cursor-pointer flex items-center justify-center gap-2">
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4 border-t border-gray-50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <button
                  ...
                  className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm px-6 py-2.5 rounded-xl transition cursor-pointer flex items-center justify-center gap-2"
                >
          ...
          {abaAtiva === "seguranca" && (
            <div className="space-y-6">
              ...
              <div className="pt-4 border-t border-gray-50 flex justify-end">
                <button type="button" className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm px-6 py-2.5 rounded-xl transition cursor-pointer">
                  Atualizar senha
                </button>
              </div>
                ...
                <div className="border border-red-100 bg-red-50/40 rounded-2xl p-4 sm:p-5 space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto shrink-0 bg-red-600 hover:bg-red-700 text-white font-bold text-xs px-4 py-2.5 rounded-xl transition flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                      <Trash2 size={14} />
                      Excluir minha conta
                    </button>
          ...
          {abaAtiva === "notificacoes" && (
            <div className="space-y-6">
              ...
              <div className="divide-y divide-gray-100">
                <div className="py-4 space-y-4">
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button type="button" onClick={() => setNotifEmailPedidos(!notifEmailPedidos)} className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors duration-200 focus:outline-none shrink-0 ${notifEmailPedidos ? 'bg-blue-600' : 'bg-gray-200'}`}>
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button type="button" onClick={() => setNotifEmailMensagens(!notifEmailMensagens)} className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors duration-200 focus:outline-none shrink-0 ${notifEmailMensagens ? 'bg-blue-600' : 'bg-gray-200'}`}>
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button type="button" onClick={() => setNotifEmailNovidades(!notifEmailNovidades)} className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors duration-200 focus:outline-none shrink-0 ${notifEmailNovidades ? 'bg-blue-600' : 'bg-gray-200'}`}>
                ...
                <div className="py-4 space-y-4">
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button type="button" onClick={() => setNotifPushMensagens(!notifPushMensagens)} className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors duration-200 focus:outline-none shrink-0 ${notifPushMensagens ? 'bg-blue-600' : 'bg-gray-200'}`}>
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button type="button" onClick={() => setNotifPushStatus(!notifPushStatus)} className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors duration-200 focus:outline-none shrink-0 ${notifPushStatus ? 'bg-blue-600' : 'bg-gray-200'}`}>
              ...
              <div className="pt-4 border-t border-gray-50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <button type="button" onClick={handleSalvarNotificacoes} disabled={carregando} className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm px-6 py-2.5 rounded-xl transition cursor-pointer flex items-center justify-center gap-2">
                  {carregando && <Loader2 size={16} className="animate-spin" />}
                  Salvar preferências
                </button>
              </div>
          ...
          {abaAtiva === "privacidade" && (
            <div className="space-y-6">
              ...
              <div className="divide-y divide-gray-100">
                <div className="py-4 space-y-4">
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button type="button" onClick={() => setPerfilPublico(!perfilPublico)} className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors duration-200 focus:outline-none shrink-0 ${perfilPublico ? 'bg-blue-600' : 'bg-gray-200'}`}>
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button type="button" onClick={() => setMostrarTelefone(!mostrarTelefone)} className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors duration-200 focus:outline-none shrink-0 ${mostrarTelefone ? 'bg-blue-600' : 'bg-gray-200'}`}>
                ...
                <div className="py-4 space-y-4">
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button type="button" onClick={() => setMostrarHistorico(!mostrarHistorico)} className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors duration-200 focus:outline-none shrink-0 ${mostrarHistorico ? 'bg-blue-600' : 'bg-gray-200'}`}>
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button type="button" onClick={() => setPermitirDicasAI(!permitirDicasAI)} className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors duration-200 focus:outline-none shrink-0 ${permitirDicasAI ? 'bg-blue-600' : 'bg-gray-200'}`}>
              ...
              <div className="pt-4 border-t border-gray-50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <button type="button" onClick={handleSalvarPrivacidade} disabled={carregando} className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm px-6 py-2.5 rounded-xl transition cursor-pointer flex items-center justify-center gap-2">
                  {carregando && <Loader2 size={16} className="animate-spin" />}
          ...
          {abaAtiva === "preferencias" && (
            <div className="space-y-6">
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={`flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-4 py-3 border rounded-xl text-[11px] sm:text-xs font-bold transition cursor-pointer ${
                            ativo
              ...
              <div className="pt-4 border-t border-gray-50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <button type="button" onClick={handleSalvarPreferencias} disabled={carregando} className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm px-6 py-2.5 rounded-xl transition cursor-pointer flex items-center justify-center gap-2">
                  {carregando && <Loader2 size={16} className="animate-spin" />}
                  Salvar preferências
                </button>
              </div>
          ...
          {abaAtiva === "suporte" && (
            <div className="space-y-8 font-sans">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
                <form onSubmit={handleEnviarSuporte} className="lg:col-span-3 border border-gray-100 rounded-2xl p-4 sm:p-6 space-y-4 shadow-sm bg-white">
                  <div>
                  ...
                  <div className="pt-2 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <button type="submit" disabled={carregando} className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs px-6 py-2.5 rounded-xl transition flex items-center justify-center gap-2">
                ...
                <div className="lg:col-span-2 space-y-4 w-full min-w-0">
                  <div className="border border-gray-100 rounded-2xl p-4 sm:p-5 space-y-3 shadow-sm bg-white">
                    <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between gap-2 border border-gray-100 rounded-xl p-3 bg-gray-50/50">
                        ...
                        <button type="button" className="shrink-0 border border-gray-200 bg-white hover:bg-gray-50 text-[10px] font-bold px-3 py-1.5 rounded-lg text-gray-700 transition">
                          Abrir chat
                        </button>
                      </div>
      ...
      {modalExclusaoAberto && (
        <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white border border-red-100 rounded-2xl shadow-xl max-w-md w-full p-5 sm:p-6 space-y-4">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-xl bg-red-100 text-red-600 flex items-center justify-center shrink-0">
                <AlertOctagon size={20} />
              </div>
